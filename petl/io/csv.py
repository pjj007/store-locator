...
def fromcsv(source=None, encoding="ascii", errors=None, **csvargs):
    """
...
def fromtsv(source=None, encoding="ascii", errors=None, **csvargs):
    """
...
def tocsv(table, source=None, encoding="ascii", errors=None, write_header=True,
          **csvargs):
    """
...
def appendcsv(table, source=None, encoding="ascii", errors=None,
...
def totsv(table, source=None, encoding="ascii", errors=None,
...
def appendtsv(table, source=None, encoding="ascii", errors=None,
              write_header=False, **csvargs):
    """
...
def teecsv(table, source=None, encoding="ascii", errors=None, write_header=True,
           **csvargs):
    """
...
def teetsv(table, source=None, encoding="ascii", errors=None, write_header=True,
           **csvargs):
    """

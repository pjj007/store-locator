...
def tohtml(table, source=None, encoding="ascii", errors=None, caption=None,
...
def teehtml(table, source=None, encoding="ascii", errors=None, caption=None,
            vrepr=text_type, lineterminator='\n', index_header=False,
            tr_style=None, td_styles=None, truncate=None):
    """
...
class TeeHTMLView(Table):
    def __init__(self, table, source=None, encoding="ascii", errors=None,
